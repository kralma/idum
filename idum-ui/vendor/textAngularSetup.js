...
angular.module('textAngularSetup', [])
    ...
    .value('taTranslations', {
        ...
        ul: {
            tooltip: 'Nečíslovaný seznam'
        },
        ol: {
            tooltip: 'Číslovaný seznam'
        },
        quote: {
            tooltip: 'Citace výběru nebo odstavce'
        },
        undo: {
            tooltip: 'Krok zpět'
        },
        redo: {
            tooltip: 'Krok dopředu'
        },
        bold: {
            tooltip: 'Tučné'
        },
        ...
        insertImage: {
            dialogPrompt: 'Zadejte prosím adresu URL obrázku',
            tooltip: 'Vložit obrázek',
            hotkey: 'the - possibly language dependent hotkey ... for some future implementation'
        },
        insertVideo: {
            tooltip: 'Vložit video',
            dialogPrompt: 'Zadejte prosím adresu URL youtube videa'
        },
        insertLink: {
            tooltip: 'Vložit / upravit hypertextový odkaz',
            dialogPrompt: "Zadejte prosím adresu URL, kterou chcete vložit"
        },
        editLink: {
            reLinkButton: {
            ...
            unLinkButton: {
                tooltip: "Zrušit odkaz"
            },
            targetToggle: {
                buttontext: "Otevřít odkaz"
            }
        },
        wordcount: {
    ...
    .run(['taRegisterTool', '$window', 'taTranslations', 'taSelection', 'taToolFunctions', '$sanitize', 'taOptions', function (taRegisterTool, $window, taTranslations, taSelection, taToolFunctions, $sanitize, taOptions) {
        ...
        taRegisterTool('wordcount', {
            display: '<div id="toolbarWC" style="font-weight: 400">Počet slov: <span ng-bind="wordcount"></span></div>',
            disabled: true,
            wordcount: 0,
            action: function () {
            },
